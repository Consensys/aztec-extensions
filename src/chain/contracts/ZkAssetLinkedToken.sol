...
contract ZkAssetLinkedToken is ZkAssetAdjustable {
    constructor(address _aceAddress, address publicToken, uint256 _scalingFactor)
        public
        ZkAssetAdjustable(_aceAddress, publicToken, _scalingFactor, 0, "")
    {}
